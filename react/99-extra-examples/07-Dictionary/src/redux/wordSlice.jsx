...
const wordSlice = createSlice({
    ...
    reducers: {
        ...
        removeWordFromDictionary: (state, action) => {
            state.word = state.word.filter((word) => word !== action.payload);
        },
...
export const {addWordFromDictionary, removeWordFromDictionary, findWordFromDictionary} = wordSlice.actions;
